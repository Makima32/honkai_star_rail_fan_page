...
function Cards() {
  return (
    <div className="container-cards">
      <div className="card">
        <img src="\img\honkai_train.jpg" alt="Expreso Astral" />
      ...
      <div className="card">
        <img src="\img\elementos.png" alt="Elementos y Caminos" />
      ...
      <div className="card">
        <img src="\img\honkai-gameplay.png" alt="Combate Estratégico" />
